      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">{t('terms.account.p1')}</p>
            <ul className="list-disc pl-6 mt-2 space-y-1 text-muted-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-2">{t('terms.freePlan.p2')}</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">{t('terms.userData.p1')}</p>
            <p className="text-muted-foreground leading-relaxed mt-2">
              {t('terms.userData.p2', { appName })}
            </p>
            <p className="text-muted-foreground leading-relaxed mt-2">{t('terms.userData.p3')}</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">{t('terms.acceptableUse.p1')}</p>
            <ul className="list-disc pl-6 mt-2 space-y-1 text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">8. {t('terms.ip.title')}</h2>
            <p className="text-muted-foreground leading-relaxed">{t('terms.ip.p1', { appName })}</p>
            <p className="text-muted-foreground leading-relaxed mt-2">{t('terms.ip.p2')}</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">{t('terms.refunds.p1')}</p>
            <p className="text-muted-foreground leading-relaxed mt-2">{t('terms.refunds.p2')}</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">{t('terms.contact.p1')}</p>
            <p className="text-muted-foreground leading-relaxed mt-2">
